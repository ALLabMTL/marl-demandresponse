...
class TestHouse(unittest.TestCase):
    ...
    def testSolarGainDate(self):
        ...
        sum_6 = (
            self.house.house_solar_gain(datetime_6_1)
            + self.house.house_solar_gain(datetime_6_2)
            + self.house.house_solar_gain(datetime_6_3)
            + self.house.house_solar_gain(datetime_6_4)
            + self.house.house_solar_gain(datetime_6_5)
        )
        sum_7 = (
            self.house.house_solar_gain(datetime_7_1)
            + self.house.house_solar_gain(datetime_7_2)
            + self.house.house_solar_gain(datetime_7_3)
            + self.house.house_solar_gain(datetime_7_4)
            + self.house.house_solar_gain(datetime_7_5)
        )
        sum_8 = (
            self.house.house_solar_gain(datetime_8_1)
            + self.house.house_solar_gain(datetime_8_2)
            + self.house.house_solar_gain(datetime_8_3)
            + self.house.house_solar_gain(datetime_8_4)
            + self.house.house_solar_gain(datetime_8_5)
        )
        sum_9 = (
            self.house.house_solar_gain(datetime_9_1)
            + self.house.house_solar_gain(datetime_9_2)
            + self.house.house_solar_gain(datetime_9_3)
            + self.house.house_solar_gain(datetime_9_4)
            + self.house.house_solar_gain(datetime_9_5)
        )
