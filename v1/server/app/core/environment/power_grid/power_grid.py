...
class PowerGrid(Simulatable):
    ...
    def _reset(self, max_power: int, nb_hvacs: int, solar_gain: bool) -> dict:
        ...
        self.initial_properties.artificial_ratio = self.initial_properties.artificial_ratio * self.initial_properties.artificial_signal_ratio_range** (
            random.random() * 2 - 1
        ) 
    ...
    def constant_base_power(self) -> None :
        self.base_power = self.initial_properties.base_power_props.avg_power_per_hvac * self.nb_hvacs
    ...
    #     # TODO: maybe move it in parser service?
    #     with open(
