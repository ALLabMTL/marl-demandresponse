...
class TrainingService():
    def __init__(self, client_manager_service: ClientManagerService) -> None:
        self. client_manager_service = client_manager_service
    
    # TODO: take all props from parser service
    ppo_props = {
        "PPO_prop": {
    ...
    def test_ppo_agent(agent, env: Environment, tr_time_steps) -> dict:
        """
    ...
    async def train_ppo(self):
        ...
        # TODO: take these arguments from config file
        nb_time_steps = 1000
        nb_test_logs = 100
        nb_tr_logs = 100
        nb_tr_epochs = 20
